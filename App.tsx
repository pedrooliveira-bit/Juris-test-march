...
const JusIAIcon = ({ size = 16, color }: { size?: number; color?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 27 32" fill="none" width={size} height={size}>
    <path fillRule="evenodd" clipRule="evenodd" fill={color || "#FC0"} d="M26.098 0H12.663c-.508 0-.944.374-1.032.883l-.36 2.09s-.004.016-.004.023L8.768 17.52h5.734c.39 0 .746.216.93.565l6.428 12.342s.077.152.102.272c.016.079.023.134.028.178v.162a1 1 0 0 1-.014.1q.006-.02.01-.04l4.788-27.732.366-2.112A1.067 1.067 0 0 0 26.098 0" />
    <path fillRule="evenodd" clipRule="evenodd" fill={color || "#3D82DA"} d="M6.478 31.181v-.004q-.007-.044-.011-.093v-.016c0-.027-.005-.057-.005-.085v-.03q0-.036.003-.074.001-.026.006-.053.002-.027.007-.055.01-.055.02-.113L8.767 17.52H1.049c-.792.002-1.298.862-.924 1.573l6.428 12.342.01.016a1 1 0 0 1-.085-.27" />
    <path fillRule="evenodd" clipRule="evenodd" fill={color || "#77B340"} d="M21.99 31.038c-.041.584-.58.969-1.026.962H7.536c-.175 0-.356-.046-.356-.046-.557-.152-.82-.676-.681-1.296L8.766 17.52H14.5c.39 0 .747.216.931.565l6.428 12.342s.077.152.102.272.03.19.03.24z" />
  </svg>
);
...
const ChevronLeftIcon = ({ size = 16, color = "currentColor" }: { size?: number; color?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="m15 18-6-6 6-6"/>
  </svg>
);

const ChevronRightIcon = ({ size = 16, color = "currentColor" }: { size?: number; color?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="m9 18 6-6-6-6"/>
  </svg>
);

const ChevronDownIcon = ({ size = 16, color = "currentColor" }: { size?: number; color?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="m6 9 6 6 6-6"/>
  </svg>
);
...
const LogoJusbrasil = () => (
  <div className="flex items-center gap-2 cursor-pointer select-none">
    ...
    <span className="font-semibold text-[18px] text-[#595B63]">Jusbrasil</span>
  </div>
);
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
      <motion.div 
        ...
        className="bg-white rounded-2xl shadow-2xl w-full max-w-[640px] h-[650px] overflow-hidden flex flex-col"
      >
        <div className="p-6 border-b border-[#E2E8F0] flex items-center justify-between">
          <div>
            <h2 className="text-[18px] font-bold text-[#0F172A]" style={{ fontFamily: 'inherit' }}>Detalhes da jurisprudência</h2>
...
// --- Componente Pontos-chave Drawer ---
const PontosChaveDrawer = ({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) => {
  ...
  useEffect(() => {
    if (isOpen) {
      ...
      // Sequence
      const userTimer = setTimeout(() => setShowUserMessage(true), 300);
      const aiTimer = setTimeout(() => setShowAIResponse(true), 1200);
      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-0 right-0 h-full w-full max-w-[500px] bg-white shadow-2xl z-[160] flex flex-col font-inter"
          >
            {/* Header */}
            <div className="p-6 border-b border-[#E2E8F0] flex items-center justify-between bg-white shrink-0">
              <h2 className="text-[18px] font-bold text-[#0F172A]">Pontos-chave do processo</h2>
              <button onClick={onClose} className="p-2 hover:bg-gray-100 rounded-full transition-colors">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#64748B" strokeWidth="2"><path d="M18 6L6 18M6 6l12 12"/></svg>
              </button>
            </div>
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-8 custom-scrollbar">
              {showUserMessage && (
                ...
                >
                  <div className="bg-[#F1F5F9] text-[#0F172A] px-5 py-3 rounded-2xl rounded-tr-none max-w-[85%] text-[15px]">
              ...
              {showAIResponse && (
                ...
                >
                  <div className="flex items-center gap-2 text-[13px] text-[#64748B] font-medium">
                    <SparkleIcon color="#007A5F" />
                    <span>Resposta</span>
                  </div>
                  
                  <div className="space-y-4">
                    <h3 className="text-[18px] font-bold text-[#0F172A]">Resumo do processo</h3>
                    <div className="text-[#334155] text-[15px] leading-relaxed space-y-4">
                      <p>
                        O tribunal entendeu que, em crime de latrocínio com múltiplas vítimas fatais, há um único crime, desde que haja unidade de desígnios. Nessa hipótese, aplica-se o concurso formal próprio, e não concurso formal impróprio ou pluralidade de crimes.
                      </p>
                      <p>
                        Além disso, foi reafirmado que o habeas corpus não pode ser utilizado como substituto de revisão criminal, salvo em situações excepcionais com fatos incontroversos — o que não se verificou no caso.
                      </p>
                      <div className="pt-2">
                        <p className="font-bold mb-2">Pontos-chave da decisão</p>
                        <ul className="list-none space-y-1">
                          <li className="flex gap-2"><span>•</span> Latrocínio é considerado crime único, mesmo com mais de uma vítima</li>
                          <li className="flex gap-2"><span>•</span> Pluralidade de mortes não gera múltiplos latrocínios automaticamente</li>
                          <li className="flex gap-2"><span>•</span> Aplicação de concurso formal próprio (art. 70, 1ª parte, CP)</li>
                          <li className="flex gap-2"><span>•</span> Habeas corpus utilizado de forma inadequada como sucedâneo de revisão criminal</li>
                          <li className="flex gap-2"><span>•</span> Recurso não provido</li>
                        </ul>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="pt-8 space-y-4">
                    <div className="flex items-center gap-2 text-[14px] text-[#0F172A] font-semibold">
                      <JusIAIcon size={18} />
                      <span>Descubra mais pontos-chave do processo com o Jus IA</span>
                    </div>
                    
                    <div className="space-y-2">
                      {[
                        "Quais foram os principais fundamentos usados pelo tribunal?",
                        "Houve condenação ou fixação de valores neste caso?",
                        "Quais pedidos foram acolhidos ou rejeitados?"
                      ].map((q, i) => (
                        <button 
                          key={i}
                          className="w-full flex items-center justify-between p-4 bg-white border border-[#E2E8F0] rounded-xl hover:border-[#007A5F] hover:bg-[#F8FAFC] transition-all text-left group"
                        >
                          <span className="text-[14px] text-[#334155] font-medium group-hover:text-[#007A5F]">{q}</span>
                          <div className="w-8 h-8 rounded-lg bg-[#F1F5F9] flex items-center justify-center text-[#94A3B8] group-hover:bg-[#EAF6F3] group-hover:text-[#007A5F]">
                            <ArrowUpIcon size={18} />
                          </div>
                        </button>
                      ))}
            ...
            <div className="p-6 border-t border-[#E2E8F0] bg-white shrink-0">
              <div className="relative flex items-center">
                <input 
                  ...
                  className="w-full h-[56px] pl-5 pr-14 bg-white border border-[#E2E8F0] rounded-xl outline-none focus:border-[#007A5F] transition-all text-[15px]"
                />
                <button className="absolute right-2 w-10 h-10 bg-[#F1F5F9] rounded-lg flex items-center justify-center text-[#94A3B8] hover:bg-[#EAF6F3] hover:text-[#007A5F] transition-all">
                  <ArrowUpIcon size={20} />
                </button>
              </div>
            </div>
...
const StickyBar = ({ isVisible, topOffset, activeTab, onTabClick, activeResumoTab, variant }: { isVisible: boolean; topOffset: number; activeTab: string; onTabClick: (tab: string) => void; activeResumoTab: string; variant: string }) => {
  return (
    <div 
    ...
    >
      <div className={`flex flex-col ${variant === 'A' ? 'px-[72px]' : 'px-4 lg:px-8'}`}>
        {/* Top Row */}
        <div className="h-[72px] flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 shrink-0">
            ...
            <button 
              ...
              onClick={() => onTabClick('Jurisprudência semelhante')}
            >
              <div className="flex items-center gap-2">
            ...
            <button 
              ...
              onClick={() => onTabClick('Pontos-chave do processo')}
            >
              <div className="flex items-center gap-2">
                <span style={{...buttonTextStyle, color: '#1E293B'}}>Pontos-chave do processo</span>
              </div>
            </button>
            {variant === 'A' && null}
          </div>
...
const AccordionItem = ({ 
  ...
  return (
    <div id={id} className={`${showBorder ? 'border-b border-[#CCD5E1]' : ''} w-full`}>
      <button 
        onClick={() => setIsOpen(!isOpen)}
        className="w-full py-6 flex items-center justify-between text-left group transition-all"
      >
        <div className="flex flex-col gap-1">
          <h2 className="text-[20px] font-bold text-[#0F172A] group-hover:text-[#007A5F] transition-colors" style={{ fontFamily: 'inherit' }}>
            {title}
          </h2>
          <div className="text-[#64748B] text-[14px]" style={{ fontFamily: 'inherit' }}>
            {description}
          </div>
        </div>
...
const Carousel = () => {
  ...
  const cards = [
    {
      type: 'entendimento',
      title: 'Entendimento do tribunal',
      chip: 'Predominante',
      text: 'Em casos de dano moral por negativação indevida, este tribunal tende a seguir o entendimento de que a inscrição indevida gera dano moral in re ipsa.',
      buttonText: 'Comparar com meu caso'
    },
    {
      type: 'pedido',
      title: 'Principal pedido',
      text: 'Anular a sentença e permitir o seguimento do processo para produção de provas testemunhais e periciais.',
      subHeader: 'Razões de decidir',
      subText: '1. A procuração apresentada não possui vício formal que imprida o prosseguimento do feito...'
    },
    {
      type: 'argumentacao',
      title: 'Argumentação da defesa',
      text: 'A falha na prestação de serviço não foi comprovada pelo autor, sendo que a empresa agiu no exercício regular de direito.',
      subHeader: 'Trecho relevante',
      subText: '“A ausência de prova do dano moral afasta o dever de indenizar, conforme entendimento consolidado...”'
    },
    {
      type: 'jurisprudencia',
      title: 'Jurisprudência citada',
      text: 'Súmula 385 do STJ: Da anotação irregular em cadastro de proteção ao crédito, não cabe indenização por dano moral, quando preexistente legítima inscrição.',
      subHeader: 'Aplicação no caso',
      subText: 'O tribunal aplicou o entendimento de que a existência de outras inscrições afasta o dano moral.'
    },
    {
      type: 'conclusao',
      title: 'Conclusão do relator',
      text: 'Voto pelo provimento parcial do recurso para reduzir o quantum indenizatório para patamares razoáveis e proporcionais.',
      subHeader: 'Dispositivo',
      subText: '“Ante o exposto, dou provimento parcial ao recurso interposto para reformar a sentença no tocante...”'
    }
  ];
  ...
  return (
    <div className="mt-8 mb-4 w-full overflow-hidden font-inter text-left">
      <div 
        className="flex gap-4 transition-transform duration-500 ease-in-out" 
        style={{ transform: `translateX(-${currentIndex * 336}px)` }}
      >
        {cards.map((card, idx) => (
          <div key={idx} className="min-w-[320px] max-w-[320px] bg-white border border-[#E2E8F0] rounded-2xl p-6 shadow-sm flex flex-col h-[280px] shrink-0">
            <div className="flex items-center gap-2 mb-3">
              <h3 className="text-[16px] font-bold text-[#0F172A]">{card.title}</h3>
              {card.type === 'entendimento' && <InfoIcon size={16} color="#64748B" />}
            </div>
            
            {card.chip && (
              <div className="flex items-center gap-2 bg-[#F0F4ED] px-3 py-1 rounded-full w-fit mb-4">
                <div className="w-2 h-2 rounded-full bg-[#4D7C0F]"></div>
                <span className="text-[12px] font-semibold text-[#4D7C0F]">{card.chip}</span>
              </div>
            )}
            
            <p className="text-[14px] text-[#475569] mb-auto line-clamp-3 leading-relaxed">
              {card.text}
            </p>
            
            {card.subHeader && (
              <div className="mt-4">
                <h4 className="text-[14px] font-bold text-[#0F172A] mb-1">{card.subHeader}</h4>
                <div className="relative">
                  <p className="text-[13px] text-[#64748B] line-clamp-1 opacity-60">{card.subText}</p>
                </div>
              </div>
            )}
            
            {card.buttonText && (
              <button className="mt-4 flex items-center gap-2 border border-[#E2E8F0] rounded-lg px-4 py-2 hover:bg-gray-50 transition-colors w-fit">
                <SparkleIcon color="#0F172A" />
                <span className="text-[14px] font-semibold text-[#0F172A]">{card.buttonText}</span>
              </button>
            )}
            
            {!card.buttonText && (
              <button className="mt-4 flex items-center gap-1 text-[#007A5F] font-semibold text-[14px] hover:underline">
      ...
      <div className="flex items-center justify-between mt-6 px-1">
        <span className="text-[14px] text-[#64748B] font-medium">{currentIndex + 1} de {cards.length}</span>
        <div className="flex gap-3">
          <button 
            onClick={prevCard}
            disabled={currentIndex === 0}
            className={`w-10 h-10 rounded-full border border-[#E2E8F0] flex items-center justify-center transition-all ${currentIndex === 0 ? 'opacity-30 cursor-not-allowed' : 'hover:bg-gray-50 active:scale-95'}`}
          >
          ...
          <button 
            ...
            className={`w-10 h-10 rounded-full border border-[#E2E8F0] flex items-center justify-center transition-all ${currentIndex >= cards.length - 1 ? 'opacity-30 cursor-not-allowed' : 'hover:bg-gray-50 active:scale-95'}`}
          >
...
const App: React.FC = () => {
  ...
  const [isPontosChaveOpen, setIsPontosChaveOpen] = useState(false);
  ...
  const handleStickyTabClick = (tab: string) => {
    const labelToId: Record<string, string> = {
      ...
      'Relatório': 'relatorio',
      'Voto': 'voto',
      'Jurisprudência semelhante': 'jurisprudencia',
      'Pontos-chave do processo': 'resumo-ia'
    };
    const id = labelToId[tab];
    if (id) {
      if (tab === 'Pontos-chave do processo') {
        setIsPontosChaveOpen(true);
      } else {
  ...
  const renderJusIABanner = (
    ...
    return (
      <div id="resumo-ia" className="flex flex-col items-start pb-[32px] mb-0 w-full border-b border-[#CCD5E1] animate-in fade-in duration-700">
        {!chipBelowTitle && chipElement}
        <h2 className="text-[var(--color-base-low-pure)] font-semibold text-[18px] mb-3 leading-tight" style={{ fontFamily: 'inherit' }}>
          {title}
        </h2>
        {chipBelowTitle && chipElement}
        <div className="text-[#5C6F8A] text-[14px] leading-relaxed mb-6" style={{ fontFamily: 'inherit' }}>
          {description}
        </div>
        <button 
          onClick={() => setIsPontosChaveOpen(true)}
          className="flex items-center gap-2.5 p-0 m-0 bg-transparent border-none cursor-pointer hover:opacity-80 transition-all"
          style={{ height: '24px', fontFamily: 'inherit' }}
        >
    ...
    <div className="min-h-screen flex flex-col bg-white font-inter text-[#1D1D1D] selection:bg-[#007A5F]/10">
      ...
      <div className={view === 'chat' ? 'h-screen pt-[40px]' : 'pt-[40px]'}>
        ...
        <header className="bg-white border-b border-[#CCD5E1]">
          <div className={`${variant === 'A' ? 'px-[72px]' : 'max-w-[980px] mx-auto px-4 lg:px-0'} h-[80px] flex items-center justify-between`}>
            <LogoJusbrasil />
            ...
            <div className="flex items-center gap-4 cursor-pointer">
              {variant === 'A' && (
                <button 
                  onClick={() => setView('chat')}
                  className="bg-gradient-to-r from-[#007A5F] to-[#7AB93D] text-white px-5 py-2.5 rounded-full flex items-center gap-2.5 font-bold text-[14px] hover:opacity-90 transition-opacity shadow-sm"
                >
                  <span>Jus IA</span>
                </button>
              )}
              <div className="flex items-center gap-2">
                <div className="w-9 h-9 rounded-full bg-[#4F378B] flex items-center justify-center text-white text-[13px] font-bold">P</div>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#475569" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="6 9 12 15 18 9"></polyline></svg>
              </div>
            </div>
          </div>
        </header>

        <main className={`${variant === 'A' ? 'max-w-[720px]' : 'max-w-[980px]'} mx-auto py-12 px-4 lg:px-0`}>
            ...
            {variant === 'D' ? (
              <div className="flex items-center w-full">
                <div className="flex items-center gap-3 text-[14px] text-[#5C6F8A]">
                  <button className="flex items-center gap-2 text-[#007A5F] font-bold hover:opacity-80">
                    ...
                    <span style={{ fontFamily: 'inherit' }}>Voltar</span>
                  </button>
                  <span className="text-[#CCD5E1]">/</span>
                  <span>Processo n. <span className="text-[#475569] hover:underline cursor-pointer">1001234-14.2020.5.02.0013</span></span>
                  <span className="text-[#CCD5E1]">/</span>
              ...
              <div className="flex items-center justify-between w-full">
                ...
                >
                  ...
                  <span style={{...buttonTextStyle, color: '#007A5F', fontFamily: 'inherit'}}>Voltar</span>
                </button>
                {variant === 'A' && (
                  <button className="text-[#2B3950] hover:opacity-70">
                    <MoreVerticalIcon />
                  </button>
                )}
              </div>
          ...
          <div className="flex flex-col lg:flex-row">
            {/* Lado Esquerdo */}
            <div className={`flex-1 min-w-0 ${variant === 'B' ? 'pr-0 lg:pr-[32px] border-r-0 lg:border-r border-[#CCD5E1]' : ''}`}>
            {variant !== 'D' && variant !== 'A' && (
            ...
            <h1 className={`text-[var(--color-base-low-pure)] text-[28px] font-semibold leading-[130%] ${variant === 'A' ? 'mb-4' : 'mb-3'}`} style={{ fontFamily: 'inherit' }}>
              ...
              <div className="flex items-start gap-4 py-1 border-l-2 border-[#CBD5E1] pl-4 mb-10 mt-6">
                <div className="flex flex-col gap-1.5">
                  <div className="flex items-center gap-2">
                    ...
                    <span 
                      className="px-2.5 h-[22px] flex items-center justify-center rounded-full bg-[#F3F8ED] text-[#007A5F] text-[12px] font-medium border border-[#F3F8ED]"
                      style={{ fontFamily: 'inherit' }}
                    >
                      Mantida
                    </span>
            ...
            {variant !== 'D' && (
              <div className={`text-[14px] text-[#475569] ${variant === 'A' ? 'mb-4' : 'mb-6'}`}>
                <span className="font-bold text-[#0F172A]">Processo n.</span> <span className="text-[#475569] hover:underline cursor-pointer">1001234-14.2020.5.02.0013</span>
              </div>
            )}
            ...
            <div className="flex flex-wrap items-center gap-4 mb-8">
              <button 
                style={buttonStyle}
                onClick={() => handleStickyTabClick('Ementa')}
              >
                <div className="flex items-center gap-2">
                  <QuoteIcon />
                  <span style={{...buttonTextStyle, color: 'white'}}>Ementa</span>
              ...
              <button 
                style={secondaryButtonStyle}
                onClick={() => handleStickyTabClick('Jurisprudência semelhante')}
              >
                <div className="flex items-center gap-2">
                  <JurisprudenciaIcon color="#007A5F" />
                  <span style={{...buttonTextStyle, color: '#007A5F'}}>Jurisprudência semelhante</span>
              ...
              {variant === 'C' && (
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span style={{...buttonTextStyle, color: '#475569', fontFamily: 'inherit'}}>Analisar processo</span>
                  </div>
                </button>
              )}
            {variant !== 'C' && variant !== 'D' && (
              <div className="ml-auto flex items-center gap-6">
                 {variant !== 'A' && <button className="text-[#2B3950] hover:opacity-70"><BookmarkIcon /></button>}
                 {variant !== 'A' && <button className="text-[#2B3950] hover:opacity-70"><MoreVerticalIcon /></button>}
              </div>
            )}
            </div>
            
            <div className={`flex items-end self-stretch border-b border-[#CCD5E1] ${variant === 'A' ? 'mb-[20px]' : 'mb-8'} justify-between`}>
              <div className="flex gap-4">
                {(variant === 'A' ? ['Panorama', 'Documentos', 'Pedidos'] : (variant === 'B' ? ['Panorama', 'Histórico', 'Atos processuais', 'Pedidos'] : ['Panorama', 'Documentos do processo', 'Pedidos'])).map(tab => (
                  <button 
                    key={tab} 
              ...
              {variant === 'B' && (
                ...
                >
                  <div className="flex items-center gap-2.5">
                    <JusIABannerIcon size={18} />
                    <span style={{...buttonTextStyle, color: '#007A5F', lineHeight: '20px', fontFamily: 'inherit'}}>Analisar processo</span>
                  </div>
                </button>
              )}
            </div>
            ...
            <section className="mb-12">
                  ...
                  {variant === 'A' ? (
                    <div>
                      <AccordionItem 
                        ...
                        title="Ementa" 
                        description={
                          <div className="flex items-center gap-1.5 text-[#334155] text-[15px] mt-0.5">
                            <span>Decisão</span>
                            <span className="w-2 h-2 rounded-full bg-[#EAB308]"></span>
                            <span className="text-[#A16207] font-bold">parcialmente reformada</span>
                            <span>, conforme <span className="underline cursor-pointer">Acórdão recorrido.</span></span>
                          </div>
                        }
                        defaultOpen={variant === 'A'}
                      >
                      ...
                      <AccordionItem 
                        id="inteiro-teor" 
                        title="Inteiro Teor" 
                        description="Texto completo da decisão judicial."
                      >
                        <div className="text-[#2B3950] text-justify font-georgia text-[17px] leading-[170%]">
                          {/* Card de anexo */}
                          <div className="mb-8 p-4 border border-[#CCD5E1] rounded-lg flex items-center justify-between bg-white max-w-[400px] not-italic font-sans">
                            <div className="flex items-center gap-3">
                              <div className="shrink-0 w-10 h-10 flex items-center justify-center bg-[#FFF1F2] rounded-lg">
                                <DocumentRedIcon />
                              </div>
                              <div className="flex flex-col min-w-0">
                                <span className="text-[14px] font-bold text-[#0F172A] truncate">Inteiro teor</span>
                                <span className="text-[12px] text-[#64748B] truncate">Inteiro Teor - TJSP - Ação ...</span>
                              </div>
                            </div>
                            <button className="shrink-0 hover:opacity-70 transition-opacity ml-4">
                              <DownloadGrayIcon />
                            </button>
                          </div>
                          ...
                          <p className="mb-6">
                            Ao final, direcionou ainda às requeridas a responsabilidade pelo pagamento das custas processuais e honorários advocatícios, sendo estes fixados no percentual correspondente a 10% sobre o valor da condenação.
                          </p>

                          <p className="mb-6">
                            Pois bem. Eis os fatos que estão a exigir devida apreciação. Examino-os sob o enfoque devolvido pelo apelo.
                          </p>

                          <p className="mb-6">
                            Como se percebe, limita-se a controvérsia recursal em perquirir se no caso em estudo estaria ou não as requeridas/apeladas obrigadas por ressarcimento dos danos morais decorrentes do não pagamento de honorários profissionais do médico responsável pela cirurgia plástica a que se submeteu à autora/apelante.
                          </p>

                          <p className="mb-6">
                            Sabe-se que os danos morais não se configuram apenas porque as obrigações de um contrato foram descumpridas. É preciso que a parte demonstre que a situação foi capaz de atingir seu patrimônio imaterial, ferindo direitos de sua personalidade.
                          </p>

                          <p className="mb-6">
                            O dano moral emerge da dor, do vexame, que, fugindo à normalidade, interfira intensamente no comportamento psicológico do indivíduo, causando-lhe aflição, angústia e desequilíbrio em seu bem-estar.
                          </p>

                          <p className="mb-6">
                            No caso em comento, há elemento concreto que permita concluir que a suposta conduta atribuída às requeridas/apeladas, a saber, em não efetuarem o pagamento dos honorários do médico responsável pela cirurgia a que se submeteu a autora/apelante, tenha importado em exposição da mesma a situação de dor e angústia, atingindo direitos de sua personalidade.
                          </p>

                          <p>
                            Evidente que a Apelante foi colocada em situação vexatória, porquanto, recebia cobranças da clínica (secretária do médico cirurgião plástico) onde realizou os procedimentos cirúrgicos, em virtude do ato ilícito praticado pelas Apeladas e passou por situações constrangedoras, angustiante, tendo a sua moral abalada, em face de todas as cobranças recebidas indevidamente em decorrência das ilicitudes perpetradas pelas Requeridas.
                          </p>
                        </div>
                      </AccordionItem>
                      ...
                      <AccordionItem 
                        id="certidao" 
                        title="Certidão de julgamento" 
                        description="Registro do resultado do julgamento."
                      >
                        <div className="text-[#2B3950] text-justify font-georgia text-[17px] leading-[170%]">
                      ...
                      <AccordionItem 
                        id="relatorio" 
                        title="Relatório e voto" 
                        description="Relatório detalhado do processo."
                        showBorder={true}
                      >
                        <div className="text-[#2B3950] text-justify font-georgia text-[17px] leading-[170%]">
                          <p className="mb-6">Superior Tribunal de Justiça</p>
                      ...
                      <div id="jurisprudencia" className={`${variant === 'A' ? 'mt-8' : 'mt-12'} ${variant === 'A' ? 'pt-0' : 'pt-8 border-t border-[#CCD5E1]'}`}>
                        <h3 className="text-[20px] font-bold text-[#0F172A] mb-6">Informações relacionadas</h3>
                        <div className="space-y-8">
                          {[
                            {
                              title: "Superior Tribunal de Justiça STJ - RECURSO ORDINARIO EM HABEAS CORPUS: RHC 79243 MG 2016/0318704-2",
                              date: "24/02/2017",
                              text: "PENAL E PROCESSO PENAL. RECURSO EM HABEAS CORPUS. 1. JUIZADO ESPECIAL CRIMINAL. AUSÊNCIA DE CITAÇÃO. NÃO OCORRÊNCIA. REVELIA DECRETADA. OBSERVÂNCIA DA LEI N. 9.099 /1995. 2. NOVAS INTIMAÇÕES PESSOAIS. DESNECESSIDADE. ARTIGO 367 DO CPP . 3. RECURSO EM HABEAS CORPUS IMPROVIDO. 1. Diversamente do afirmado no recurso, a regra trazida no art. 66 da Lei n. 9.099 /1995 foi observada, sendo o recorrente citado pessoalmente, por mandado apresentado pelo oficial justiça, no qual após sua assinatura. Assim, não há espaço para aplicação da norma trazida no parágrafo..."
                            },
                            {
                              title: "Superior Tribunal de Justiça STJ - RECURSO EM HABEAS CORPUS: RHC 113143 SP 2019/0145093-9",
                              date: "24/02/2017",
                              text: "Superior Tribunal de Justiça 13 RR RECURSO EM HABEAS CORPUS Nº 113.143 - SP (2019/0145093-9) RELATOR : MINISTRO ANTONIO SALDANHA PALHEIRO RECORRENTE : TIAGO DE MORAIS LISBOA ADVOGADO : GUSTAVO PEREIRA... A liminar em habeas corpus, bem como em recurso ordinário em habeas corpus, não possui previsão legal, tratando-se de criação jurisprudencial que visa a minorar os efeitos de eventual ilegalidade que se... DEFINA - SP168557 RECORRIDO : MINISTÉRIO PÚBLICO DO ESTADO DE SÃO PAULO DECISÃO Trata-se de recurso ordinário em habeas corpus com pe..."
                            },
                            {
                              title: "STJ - RECURSO EM HABEAS CORPUS: RHC 79243 MG 2016/0318704-2",
                              date: "14/12/2016",
                              text: "Superior Tribunal de Justiça RECURSO EM HABEAS CORPUS Nº 79.243 - MG (2016/0318704-2) RELATOR : MINISTRO REYNALDO SOARES DA FONSECA RECORRENTE : WAN EFSON LOPES CAMPOS ADVOGADO : DEFENSORIA PÚBLICA DO... ESTADO DE MINAS GERAIS RECORRIDO : MINISTÉRIO PÚBLICO DO ESTADO DE MINAS GERAIS DECISÃO Trata-se de recurso ordinário em habeas corpus , com pedido de liminar, interposto por WAN EFSON LOPES CAMPOS, contra... De início, o presente habeas corpus não comporta conhecimento, pois impetrado em substituição a recurso própriopresentado pelo oficial justiça, no qual após sua assinatura. Assim, não há espaço para aplicação da norma trazida no parágrafo único d..."
                            }
                          ].map((item, i) => (
                            <div key={i} className="flex flex-col gap-2">
                              <a href="#" className="text-[#007A5F] text-[16px] font-bold hover:underline leading-tight">
                                {item.title}
                              </a>
                              <div className="text-[#64748B] text-[13px] flex items-center gap-1.5">
                                <span>Jurisprudência</span>
                                <span className="text-[#CCD5E1]">•</span>
                                <span>Acórdão</span>
                                <span className="text-[#CCD5E1]">•</span>
                                <span>Data de publicação: {item.date}</span>
                              </div>
                              <div className="mt-1 pl-4 border-l-2 border-[#E2E8F0] relative">
                                <p className="text-[#475569] text-[14px] leading-relaxed line-clamp-4">
                                  <span className="inline-flex items-center px-2 h-[20px] rounded bg-[#F1F5F9] text-[#64748B] text-[11px] font-bold mr-2 align-middle">Ementa</span>
                                  {item.text}
                                </p>
                              </div>
                            </div>
              ...
              {(activeResumoTab === 'Atos processuais' || (variant === 'A' && activeResumoTab === 'Documentos')) && (
                <div className="flex flex-col w-full">
                  <h2 className="text-[24px] font-semibold mb-6 text-[var(--color-base-low-pure)]">{variant === 'A' ? 'Documentos' : 'Atos processuais'}</h2>
            ...
            <div className="w-full lg:w-[320px] shrink-0 pl-0 lg:pl-[24px] mt-12 lg:mt-0">
              <div className="flex flex-col items-start self-stretch">
                ...
                <div className="flex flex-col self-stretch">
                  <h6 className="text-[var(--color-base-low-pure)] font-semibold text-[14px] mb-2 leading-[170%]" style={{ fontFamily: 'inherit' }}>De onde vêm as informações do Jusbrasil?</h6>
                  <p className="text-[#5C6F8A] text-[12px] font-normal leading-[130%]" style={{ fontFamily: 'inherit' }}>
                    Todas as informações exibidas neste documento foram coletadas dos Sistemas dos Tribunais e dos Diários Oficiais. Eventuais anonimizações e/ou exclusões de dados pessoais poderão ser realizadas como salvaguardas e em respeito aos direitos do titular dos dados.
                  </p>
                </div>
              </div>
        ...
        <PontosChaveDrawer isOpen={isPontosChaveOpen} onClose={() => setIsPontosChaveOpen(false)} />
          </>
        )}
      </div>
